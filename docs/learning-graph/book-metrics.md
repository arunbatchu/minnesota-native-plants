...
| Equations | 3 | - | LaTeX expressions (inline and display) |
| MicroSims | 22 | [Simulations](../sims/index.md) | Interactive MicroSims |
| Total Words | 145,296 | - | Words in all markdown files |
| Links | 120 | - | Hyperlinks in markdown format |
| Equivalent Pages | 592 | - | Estimated pages (250 words/page + visuals) |
