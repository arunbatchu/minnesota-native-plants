# Learning Graph for Minnesota Native Plants
...
- Validates course description has sufficient depth for generating 288 concepts
...
- Connectivity: all 288 nodes connected in a single component
