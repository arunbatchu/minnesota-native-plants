...
```mermaid
flowchart TD
    subgraph above["Above Ground"]
        SKY["Sunlight & Rain"]
        CANOPY["Flower & Seed Heads<br/>6-8 ft: Big Bluestem, Indian Grass"]
        MID["Mid-Height Foliage<br/>2-4 ft: Little Bluestem, Wildflowers"]
        GROUND["Ground Level<br/>Sedges, Mosses, Leaf Litter"]
    end
    subgraph below["Below Ground (2/3 of biomass)"]
        SHALLOW["Shallow Roots: 0-2 ft<br/>Prairie Dropseed, Sedges"]
        MEDIUM["Medium Roots: 2-6 ft<br/>Switchgrass, Little Bluestem"]
        DEEP["Deep Roots: 6-10 ft<br/>Big Bluestem, Purple Coneflower"]
        VDEEP["Very Deep Roots: 10-15 ft<br/>Compass Plant, Leadplant"]
    end

    SKY --> CANOPY --> MID --> GROUND
    GROUND --> SHALLOW --> MEDIUM --> DEEP --> VDEEP

    style SKY fill:#87CEEB,color:#000
    style CANOPY fill:#9ACD32,color:#000
    style MID fill:#6B8E23,color:#fff
    style GROUND fill:#8B7355,color:#fff
    style SHALLOW fill:#CD853F,color:#fff
    style MEDIUM fill:#A0522D,color:#fff
    style DEEP fill:#8B4513,color:#fff
    style VDEEP fill:#5C3317,color:#fff
```
...
<details markdown="1">
<summary>Prairie Root Depth Comparison</summary>
Type: microsim
...
```mermaid
flowchart TD
    A["Prairie grows through<br/>spring & summer"] --> B["Dead plant litter<br/>(thatch) accumulates"]
    B --> C["Thatch smothers new growth;<br/>tree seedlings establish"]
    C --> D["Fire sweeps across<br/>the prairie"]
    D --> E["Thatch removed;<br/>tree seedlings killed"]
    E --> F["Ash returns nutrients<br/>to soil"]
    F --> G["Soil warms earlier<br/>in spring"]
    G --> H["Warm-season grasses &<br/>wildflowers flourish"]
    H --> I["Increased flowering<br/>& seed production"]
    I --> A
...
<details markdown="1">
<summary>Prairie Fire Ecology Simulator</summary>
Type: microsim
...
!!! mascot-warning "Safety First!"
    <img src="../../img/mascot/warning.png" class="mascot-admonition-img" alt="Bree holding warning sign">
