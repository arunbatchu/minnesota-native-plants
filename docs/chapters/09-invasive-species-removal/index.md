...
<details markdown="1">
<summary>Removal Strategy Selector MicroSim</summary>
Type: microsim
...
```mermaid
flowchart TD
    A[Assess Site<br>and Species] --> B[Set Goals:<br>Reduce, Contain,<br>or Eradicate]
    B --> C[Choose Methods]
    C --> D[Manual:<br>Hand-Pull, Dig, Cut]
    C --> E[Mechanical:<br>Mow, Brush Cut, Fire]
    C --> F[Chemical:<br>Cut-Stump, Basal Bark]
    C --> G[Biological:<br>Biocontrol, Grazing]
    D --> H[Implement Plan<br>Starting with Priority Areas]
    E --> H
    F --> H
    G --> H
    H --> I[Monitor Results:<br>Regrowth? New Invasions?]
    I --> J{Goals Met?}
    J -->|No| K[Adapt Methods<br>and Repeat]
    K --> C
    J -->|Yes| L[Shift to Long-Term<br>Maintenance and Monitoring]
    L --> I
```
...
```mermaid
flowchart LR
    Y1[Year 1:<br>Survey, Map,<br>Initial Removal] --> Y2[Year 2:<br>Treat Regrowth,<br>Pull Seedlings,<br>Replant Natives]
    Y2 --> Y3[Year 3:<br>Continue Seedling<br>Removal, Evaluate<br>Native Recovery]
    Y3 --> Y4[Years 4-5:<br>Seed Bank Declines,<br>Natives Fill In,<br>Spot Treatment]
    Y4 --> Y5[Year 5+:<br>Annual Monitoring,<br>Prescribed Fire/Mow,<br>Long-Term Stewardship]
```
