...
```mermaid
flowchart LR
    Start["I want to plant<br>native plants"] --> Q1{"What do I<br>need first?"}

    Q1 -->|"Advice & Planning"| A1["Contact your<br>county SWCD"]
    Q1 -->|"Funding Help"| A2["Apply for Lawns<br>to Legumes or<br>SWCD Cost-Share"]
    Q1 -->|"Plants & Seeds"| A3["Find a MN native<br>plant nursery<br>(Chapter 14 list)"]
    Q1 -->|"Learn & Connect"| A4["Join MN Native<br>Plant Society or<br>visit a Nature Center"]
    Q1 -->|"Check the Rules"| A5["Call City Hall<br>about ordinances<br>& permits"]

    A1 --> R["Start Your<br>Native Garden!"]
    A2 --> R
    A3 --> R
    A4 --> R
    A5 --> R
...
```mermaid
graph TD
    A["State Government"] --> B["MN DNR"]
    A --> C["BWSR"]
    A --> D["State Grant Programs"]
    A --> E["Noxious Weed &<br>Native Plant Law"]

    F["County Level"] --> G["Soil & Water<br>Conservation Districts"]
    F --> H["Master Gardeners"]
    F --> I["County Parks"]

    J["City Level"] --> K["Local Ordinances<br>& Permits"]
    J --> L["City Native Plant<br>Programs & Rebates"]
    J --> M["Boulevard &<br>Urban Forestry"]

    N["Educational<br>Institutions"] --> O["U of MN Extension"]
    N --> P["MN Landscape<br>Arboretum"]
    N --> Q["Nature Centers &<br>Public Gardens"]

    R["Nonprofits &<br>Volunteers"] --> S["MN Native<br>Plant Society"]
    R --> T["Land Trusts"]
    R --> U["Conservation<br>Volunteers"]
...
<details markdown="1">
<summary>Minnesota Resource Finder</summary>
Type: microsim
