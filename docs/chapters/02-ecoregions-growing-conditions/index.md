...
```mermaid
flowchart LR
    subgraph WEST["West -- Drier, Flatter"]
        TP["Tallgrass<br/>Prairie"]
    end
    subgraph CENTER["Central -- Transition"]
        PFB["Prairie-Forest<br/>Border<br/>(Oak Savanna)"]
    end
    subgraph EAST["East & South -- More Moisture"]
        DF["Deciduous<br/>Forest"]
    end
    subgraph NORTHEAST["Northeast -- Cold, Thin Soils"]
        CF["Coniferous<br/>(Boreal) Forest"]
    end

    TP -- "Increasing rainfall →" --> PFB
    PFB -- "Less fire, more trees →" --> DF
    DF -- "Colder, shorter season →" --> CF

    style TP fill:#FFECB3,color:#000
    style PFB fill:#DCEDC8,color:#000
    style DF fill:#C8E6C9,color:#000
    style CF fill:#B2DFDB,color:#000
```
...
<details markdown="1">
<summary>Minnesota Ecoregion Explorer</summary>
Type: microsim
...
- **Swamps** — Forested wetlands dominated by trees like Black Ash (*Fraxinus nigra*), Tamarack (*Larix laricina*), or Northern White Cedar (*Thuja occidentalis*).
- **Floodplain forests** — Wooded areas along rivers that are periodically flooded, supporting Silver Maple (*Acer saccharinum*) and cottonwoods.
...
```mermaid
flowchart TD
    subgraph zones["Minnesota USDA Hardiness Zones (North → South)"]
        Z3A["Zone 3a: -40 to -35 F<br/>International Falls, Boundary Waters<br/>90-110 frost-free days"]
        Z3B["Zone 3b: -35 to -30 F<br/>Bemidji, Grand Rapids, Duluth<br/>110-130 frost-free days"]
        Z4A["Zone 4a: -30 to -25 F<br/>St. Cloud, Brainerd, Western Prairie<br/>130-145 frost-free days"]
        Z4B["Zone 4b: -25 to -20 F<br/>Twin Cities, Mankato<br/>140-155 frost-free days"]
        Z5A["Zone 5a: -20 to -15 F<br/>Rochester, Winona, SE Bluffs<br/>150-170 frost-free days"]
    end

    Z3A --> Z3B --> Z4A --> Z4B --> Z5A

    style Z3A fill:#E1BEE7,color:#000
    style Z3B fill:#BBDEFB,color:#000
    style Z4A fill:#B3E5FC,color:#000
    style Z4B fill:#C8E6C9,color:#000
    style Z5A fill:#FFECB3,color:#000
```
...
<details markdown="1">
<summary>Hardiness Zone Lookup</summary>
Type: microsim
...
- **Sandy soils** suit drought-tolerant prairie species like Prairie Dropseed, Butterfly Milkweed (*Asclepias tuberosa*), and Pasque Flower (*Anemone patens*)
- **Clay soils** suit moisture-tolerant species like Blue Flag Iris (*Iris versicolor*), Joe Pye Weed (*Eutrochium maculatum*), and Swamp Milkweed (*Asclepias incarnata*)
...
!!! mascot-celebration "Wonderful Progress!"
    <img src="../../img/mascot/celebration.png" class="mascot-admonition-img" alt="Bree celebrating">
