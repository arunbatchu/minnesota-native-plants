...
```mermaid
flowchart LR
    A[Year 1:<br>Pioneer Species<br>Canada Wild Rye,<br>Black-Eyed Susan] --> B[Years 2-3:<br>Early Successional<br>Interseed Forbs,<br>Add Plugs of<br>Shooting Star]
    B --> C[Years 3-5:<br>Mid-Successional<br>Core Community<br>Establishes,<br>First Burns]
    C --> D[Years 5+:<br>Late Successional<br>Conservative Species<br>Prairie Gentian,<br>Lady's Slipper]
    D --> E[Mature Ecosystem:<br>Self-Sustaining<br>Community with<br>Full Diversity]
```
...
```mermaid
flowchart TD
    A[Plan:<br>Set Goals, Choose<br>Management Actions] --> B[Implement:<br>Seeding, Burning,<br>Invasive Removal]
    B --> C[Monitor:<br>Measure Species Diversity,<br>Invasive Cover, Wildlife Use]
    C --> D[Evaluate:<br>Compare Results<br>Against Goals]
    D --> E{Goals<br>Met?}
    E -->|No| F[Adjust:<br>Modify Methods,<br>Add Species, Change<br>Fire Frequency]
    F --> A
    E -->|Yes| G[Continue Monitoring<br>and Long-Term<br>Stewardship]
    G --> C
```
...
<details markdown="1">
<summary>Restoration Timeline Simulator MicroSim</summary>
Type: microsim
