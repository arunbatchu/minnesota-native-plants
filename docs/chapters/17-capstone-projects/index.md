...
```mermaid
flowchart LR
    P1["Phase 1<br>Site Assessment"] --> P2["Phase 2<br>Design Goals &<br>Plant Selection"]
    P2 --> P3["Phase 3<br>Design Drawing"]
    P3 --> P4["Phase 4<br>Sourcing &<br>Budget"]
    P4 --> P5["Phase 5<br>Maintenance<br>Plan"]
...
<details markdown="1">
<summary>Garden Design Planner</summary>
Type: microsim
...
```mermaid
flowchart TD
    A["What interests<br>you most?"] --> B{"Hands-on<br>design &<br>planting?"}
    A --> C{"Community<br>impact?"}
    A --> D{"Scientific<br>observation<br>& analysis?"}
    A --> E{"Practical<br>tools you can<br>use right away?"}
    A --> F{"Fighting<br>invasive<br>species?"}

    B -->|"Yes"| B1["Garden Design<br>Capstone<br>(Concept 281)"]
    C -->|"Yes"| C1{"Teaching<br>or habitat?"}
    C1 -->|"Teaching"| C2["Community Education<br>Presentation<br>(Concept 285)"]
    C1 -->|"Habitat"| C3["Pollinator Corridor<br>Plan<br>(Concept 283)"]
    D -->|"Yes"| D1{"Field work<br>or systems<br>analysis?"}
    D1 -->|"Field work"| D2["Field Guide<br>Creation<br>(Concept 284)"]
    D1 -->|"Systems"| D3["Systems Map<br>Project<br>(Concept 287)"]
    E -->|"Yes"| E1{"Calendar or<br>reference<br>guide?"}
    E1 -->|"Calendar"| E2["Maintenance Calendar<br>Project<br>(Concept 282)"]
