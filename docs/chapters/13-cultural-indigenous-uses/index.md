...
graph TD
    ...
    C --> C1["Teas & Poultices"]
    C --> C2["Wound Care"]
    C --> C3["Respiratory Remedies"]

    D --> D1["Cordage & Rope"]
    D --> D2["Birch Bark Canoes"]
    D --> D3["Dyes & Weaving"]

    E --> E1["Tobacco Offerings"]
    E --> E2["Sweetgrass Smudging"]
    E --> E3["Cedar Purification"]

    F --> F1["Controlled Burning"]
    F --> F2["Selective Harvesting"]
    F --> F3["Transplanting & Tending"]

    style A fill:#C8E6C9,color:#000
    style B fill:#DCEDC8,color:#000
...
<details markdown="1">
<summary>Ethnobotany Explorer</summary>
Type: microsim
...
```mermaid
graph LR
    A["Indigenous<br>Controlled Burn"] --> B["Dead Vegetation<br>Cleared"]
    B --> C["Fresh Growth<br>of Grasses & Forbs"]
    C --> D["Game Animals<br>Attracted"]
    D --> E["Hunting &<br>Food Supply"]

    B --> F["Ash Returns<br>Nutrients to Soil"]
    F --> C

    A --> G["Woody Encroachment<br>Prevented"]
    G --> H["Prairies & Savannas<br>Maintained"]
    H --> I["Fire-Adapted Plants<br>Thrive"]
    I --> J["Berry & Root<br>Production Increases"]
    J --> E

    style A fill:#FFCDD2,color:#000
    style E fill:#C8E6C9,color:#000
    style H fill:#DCEDC8,color:#000
```
