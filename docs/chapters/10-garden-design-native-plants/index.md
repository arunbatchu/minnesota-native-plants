...
<details markdown="1">
<summary>Site Assessment Tool MicroSim</summary>
Type: microsim
...
```mermaid
flowchart TD
    A[Site Assessment] --> B[Sun Exposure<br>Analysis]
    A --> C[Soil Moisture<br>and Type Testing]
    A --> D[Microclimate<br>Mapping]
    B --> E[Plant Selection]
    C --> E
    D --> E
    E --> F{Match Plants to<br>Site Conditions}
    F --> G[Choose Species by<br>Light, Moisture, Soil,<br>Bloom Time, Wildlife Value]
    G --> H[Plan Seasonal<br>Bloom Sequence:<br>Spring through Fall]
    H --> I[Garden Layout<br>Planning]
    I --> J[Arrange by Height:<br>Tall in Back,<br>Short in Front]
    I --> K[Plant in Drifts<br>of 3-7 per Species]
    I --> L[Define Edges<br>and Focal Points]
    J --> M[Final Design<br>Ready to Plant]
    K --> M
    L --> M
```
...
<details markdown="1">
<summary>Garden Layout Planner MicroSim</summary>
Type: microsim
...
```mermaid
flowchart TD
    R[Rainfall] --> S[Runoff from Roof<br>or Driveway]
    S --> RG[Rain Garden Basin<br>4-8 inches deep]
    RG --> Z1[Zone 1 - Center:<br>Wettest - Standing Water<br>Blue Flag Iris, Sedges,<br>Marsh Marigold]
    RG --> Z2[Zone 2 - Slopes:<br>Moist but Not Saturated<br>Joe-Pye Weed, Black-Eyed<br>Susan, Switch Grass]
    RG --> Z3[Zone 3 - Rim:<br>Driest Area<br>Little Bluestem,<br>Coneflower, Dropseed]
    Z1 --> F[Water Filters Through<br>Deep Native Roots]
    Z2 --> F
    Z3 --> F
    F --> G[Groundwater<br>Recharged]
```
