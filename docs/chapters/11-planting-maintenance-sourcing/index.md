...
flowchart TD
    ...
    F[Fall<br>Sep - Nov] -->|Plant plugs and containers<br>Dormant seed after hard frost<br>Leave seed heads standing<br>Mulch new plantings| W
```
...
<details markdown="1">
<summary>Interactive Planting Calendar MicroSim</summary>
Type: microsim
...
flowchart TD
    ...
    G --> I[Acceptable for<br>Ornamental Gardens]
```
